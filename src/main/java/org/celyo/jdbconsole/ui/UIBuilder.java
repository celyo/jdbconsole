...
public class UIBuilder {
    ...
    public void build(TerminalSize screenSize) {
        ...
        buildSQLPanel(new TerminalSize(screenSize.getColumns(), (screenSize.getRows() - TOOLBAR_HEIGHT) / 2));
        buildResultPanel(new TerminalSize(screenSize.getColumns(), (screenSize.getRows() - TOOLBAR_HEIGHT) / 2));
